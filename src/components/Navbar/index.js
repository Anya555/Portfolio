...
function Navbar() {
  return (
    ...
    <a href="https://www.linkedin.com/in/anna-panas-0a51a8a8/"  target="_blank" rel="noopener noreferrer"><FaLinkedinIn className="linkedin"/></a>
    <a href="https://github.com/Anya555?tab=repositories"  target="_blank" rel="noopener noreferrer"><FaGithub className="github"/></a>
